  ...
  return (
    <main className="px-6 py-10 sm:py-14">
      <div className="max-w-3xl mx-auto">
        ...
        <Link
          href="/field-journal"
          className="group relative flex flex-col overflow-hidden rounded-2xl border border-btf-gold/30 bg-white/[0.055] p-5 transition-all hover:-translate-y-0.5 hover:border-btf-gold/40 hover:bg-white/[0.08] mb-6"
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-[10px] tracking-[0.2em] uppercase text-btf-gold-light font-semibold">
          ...
          <h2 className="font-serif text-xl text-white font-light leading-snug mb-1">
          ...
          <span className="mt-3 text-[10px] uppercase tracking-[0.25em] text-btf-gold-light font-semibold group-hover:translate-x-1 transition-transform">
        ...
        <ul className="grid sm:grid-cols-2 gap-4">
          {EXERCISES.map((ex, i) => (
            <li key={ex.slug}>
              <Link
                href={`/tools/${ex.slug}`}
                className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-white/[0.09] bg-white/[0.055] p-5 transition-all hover:-translate-y-0.5 hover:border-btf-gold/40 hover:bg-white/[0.08] focus:outline-none focus-visible:ring-2 focus-visible:ring-btf-gold focus-visible:ring-offset-2 focus-visible:ring-offset-transparent"
              >
                ...
                <div className="relative flex items-center justify-between mb-3">
                  <span className="inline-flex items-center rounded-full bg-btf-gold/[0.14] border border-btf-gold/30 px-2.5 py-1 text-[10px] tracking-[0.2em] uppercase text-btf-gold-light font-semibold">
                ...
                <h2 className="font-serif text-xl text-white font-light leading-snug mb-2 relative">
                  {ex.name}
                </h2>
                <p className="text-sm text-white/70 font-light leading-relaxed relative mb-5 flex-1">
                  {ex.tagline}
                </p>

                <p className="relative text-[11px] tracking-[0.2em] uppercase font-semibold text-btf-gold-light group-hover:text-btf-gold transition-colors">
        ...
        <p className="mt-10 rounded-xl border border-white/[0.09] bg-white/[0.055] px-5 py-4 text-xs leading-relaxed text-white/70 font-light">
          These tools are not a substitute for a clinician. If you&rsquo;re in immediate danger, use the crisis button at the bottom of the screen, or call <a href="tel:988" className="text-btf-gold-light font-medium underline-offset-2 hover:underline">988</a> right now.
        </p>
      </div>
    </main>
  );
